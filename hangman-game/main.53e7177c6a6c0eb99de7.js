...
"use strict";
module.exports = __webpack_require__.p + "assets/icons8-hangman-16.png";
...
var ___HTML_LOADER_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(6182), __webpack_require__.b);
// Module
var ___HTML_LOADER_REPLACEMENT_0___ = getUrl_default()(___HTML_LOADER_IMPORT_0___);
var code = "<!DOCTYPE html> <html lang=\"en\"> <head> <meta charset=\"UTF-8\"/> <meta name=\"viewport\" content=\"width=device-width,initial-scale=1minimum-scale=1\"/> <title>Hangman</title> <link rel=\"icon\" type=\"image/x-icon\" href=\"" + ___HTML_LOADER_REPLACEMENT_0___ + "\"/> </head> <body></body> </html> ";
// Exports
/* harmony default export */ var src = ((/* unused pure expression or super */ null && (code)));
;// CONCATENATED MODULE: ./src/modules/helpers.js
...
;// CONCATENATED MODULE: ./src/assets/images/piece-of-paper.jpg
var piece_of_paper_namespaceObject = __webpack_require__.p + "assets/piece-of-paper.jpg";
;// CONCATENATED MODULE: ./src/assets/images/gallows.png
var gallows_namespaceObject = __webpack_require__.p + "assets/gallows.png";
;// CONCATENATED MODULE: ./src/modules/quizComponent.js

var wordArr = [];
var quizWordContainer = null;
var guessesCounterContainer = null;
var wordToGuess = "";
function createComponent(quizQuestion) {
  wordToGuess = quizQuestion.answer.toUpperCase();
  var wordLength = quizQuestion.answer.length;
  wordArr = wordToGuess.split("");
  var quiz = createElement("div", ["quiz"]);
  quizWordContainer = createElement("div", ["quiz-word", "flex", "flex-jc-center", "flex-ai-center"]);
  wordArr.forEach(function (word) {
    var letterContainer = createElement("div", ["letter", "flex", "flex-jc-center", "flex-ai-center"]);
  ...
  var hint = createElement("h2", ["hint", "flex", "flex-fw-wrap"]);
  hint.textContent = "Hint: " + quizQuestion.question;
  var incorrectGuesses = createElement("p", ["hint"]);
...
;// CONCATENATED MODULE: ./src/modules/modalComponent.js




var modal = null;
function modalComponent_createComponent(isWinner) {
  modal = createElement("div", ["modal"]);
  var container = createElement("div", ["modal-container", "flex", "flex-fd-column", "flex-jc-center"]);
  var message = createElement("h2", ["modal-message"]);
  message.textContent = isWinner ? "Hooray, you win!" : "Unfortunately, you lost!";
  var word = createElement("div", ["modal-word"]);
  word.textContent = "The secret word is ***".concat(wordToGuess, "***");
  var button = createElement("button", ["modal-button"]);
  button.textContent = "play again";
  button.addEventListener("click", function () {
    modal.remove();
    var frame = document.getElementById("frame");
    frame.remove();
    var newFrameSection = frameComponent_createComponent();
    var body = document.getElementsByTagName("body")[0];
    body.append(newFrameSection);
    setIncorrectGuessesCounter(0);
  });
...
;// CONCATENATED MODULE: ./src/modules/keyboardComponent.js




var incorrectGuessesCounter = 0;
var maxIncorrectNumber = 6;
var keysArr = [];
function keyboardComponent_createComponent() {
  keysArr = ["Q", "W", "E", "R", "T", "Y", "U", "I", "O", "P", "A", "S", "D", "F", "G", "H", "J", "K", "L", "Z", "X", "C", "V", "B", "N", "M"];
  var keyboard = createElement("div", ["keyboard"]);
  keysArr.forEach(function (key) {
    var keyBtn = createElement("div", ["key", "flex", "flex-jc-center", "flex-ai-center"]);
...
function keyBtnClickHandler(event) {
  var clickedKeyBtn = event.target.innerText;
...
function keyPressHandler(event) {
  ...
  if (keysArr.includes(pressedKey)) {
    var virtualBtn = document.getElementById(pressedKey);
    virtualBtn.click();
  }
}
...
function openLetter(letterToGuess) {
  if (isGuessCorrect(letterToGuess)) {
    var letterDivs = quizWordContainer.querySelectorAll("div");
    letterDivs.forEach(function (letter, index) {
...
function countIncorrectGuesses(letterToGuess) {
  if (!isGuessCorrect(letterToGuess) && !isEndGame()) {
    ...
    guessesCounterContainer.innerHTML = "".concat(incorrectGuessesCounter, " / 6");
    showBodyPart();
  }
}
function isEndGame() {
...
function areAllLettersOpen() {
  var letterDivs = Array.from(quizWordContainer.querySelectorAll("div"));
  return letterDivs.every(function (letter) {
    return letter.style.color === "black";
  });
}
function createModal() {
  if (isEndGame()) {
    var modal = modalComponent_createComponent(areAllLettersOpen());
    var body = document.getElementsByTagName("body")[0];
    body.append(modal);
  }
}
function showBodyPart() {
  var bodyPart = gallowsBody.getElementsByClassName("hidden")[0];
...
;// CONCATENATED MODULE: ./src/quizQuestions.js
var quizJSON = [{
  question: "What is the main ingredient in guacamole?",
  answer: "Avocado"
}, {
  question: "Which Italian dish features thin sheets of pasta layered with cheese and meat sauce?",
  answer: "Lasagna"
}, {
  question: "What type of seafood is often used in traditional paella?",
  answer: "Shrimp"
}, {
  question: "In which country did the sandwich originate?",
  answer: "England"
}, {
  question: "Which fruit is known as the 'king of fruits' and has a distinctive smell?",
  answer: "Durian"
}, {
  question: "Which type of cheese is often used in traditional Greek salads?",
  answer: "Feta"
}, {
  question: "In which country did the dish known as 'sushi' originate?",
  answer: "Japan"
}, {
  question: "What is the name of the Korean dish made with fermented vegetables, typically cabbage or radishes?",
  answer: "Kimchi"
}, {
  question: "What is the traditional Middle Eastern dip made from mashed chickpeas, tahini, lemon juice, and garlic?",
  answer: "Hummus"
}, {
  question: "What is the name of the Mexican dish that consists of a rolled tortilla filled with meat, beans, and cheese?",
  answer: "Burrito"
}];
;// CONCATENATED MODULE: ./src/modules/frameComponent.js
...
function frameComponent_createComponent() {
  var randomNumber = Math.floor(Math.random() * 10);
  var frame = createElement("div", ["frame", "flex", "flex-fd-row", "flex-fw-wrap", "flex-jc-space-evenly"]);
  frame.id = "frame";
  frame.style.background = "url(".concat(piece_of_paper_namespaceObject, ") no-repeat center / cover");
  var gallowsPart = createElement("div", ["flex", "flex-fd-column", "flex-jc-center"]);
  var quizPart = createElement("div", ["flex", "flex-fd-column", "flex-jc-center"]);
  var titleContainer = createElement("div", ["frame-title"]);
  var title = createElement("h1", []);
  title.textContent = "HANGMAN GAME";
  var gallowsContainer = createElement("div", ["gallows-container"]);
  var img = createElement("img", []);
  img.src = gallows_namespaceObject;
  img.alt = "Gallows";
  var gallowsBody = gallowsComponent_createComponent();
  var quizContainer = createElement("div", []);
  var keyboardContainer = createElement("div", []);
  var quizSection = createComponent(quizJSON[randomNumber]);
  var keyboardSection = keyboardComponent_createComponent();
...
var body = document.getElementsByTagName("body")[0];
var frameSection = frameComponent_createComponent();
body.append(frameSection);
}();
/******/ })()
;
//# sourceMappingURL=main.53e7177c6a6c0eb99de7.js.map